...
class AdminCustomerFormController extends Controller
{
    public function __construct(private readonly CustomerFormSettings $settings)
    {
    }

    public function show()
    {
        return response()->json(['data' => $this->settings->adminPayload()]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return response()->json(['data' => $this->settings->update($validated['types'])]);
    }
}
