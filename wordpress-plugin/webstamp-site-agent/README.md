...
The endpoint is read-only and exposes operational versions, update counts, database size, active theme and debug state. It does not expose users, passwords, configuration contents, files or database records.
