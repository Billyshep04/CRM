...
return new class extends Migration {
    ...
    {
        if (!Schema::hasTable('hosting_accounts')) Schema::create('hosting_accounts', function (Blueprint $table): void {
        ...
        if (!Schema::hasTable('hosting_packages')) Schema::create('hosting_packages', function (Blueprint $table): void {
        ...
        if (!Schema::hasTable('wordpress_profiles')) Schema::create('wordpress_profiles', function (Blueprint $table): void {
        ...
        if (!Schema::hasTable('website_provisioning_runs')) Schema::create('website_provisioning_runs', function (Blueprint $table): void {
        ...
        if (!Schema::hasTable('website_provisioning_steps')) Schema::create('website_provisioning_steps', function (Blueprint $table): void {
        ...
        if (!Schema::hasColumn('websites', 'hosting_account_id')) Schema::table('websites', function (Blueprint $table): void { $table->foreignId('hosting_account_id')->nullable()->after('hosting_server_id')->constrained('hosting_accounts')->nullOnDelete(); });
        if (!Schema::hasColumn('websites', 'provisioning_status')) Schema::table('websites', function (Blueprint $table): void { $table->string('provisioning_status')->nullable()->index(); });
