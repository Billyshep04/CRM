...
use App\Http\Controllers\RecurringCostController;
...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::middleware('role:admin,staff')->group(function (): void {
        ...
        Route::get('website-analytics/properties', [WebsiteAnalyticsController::class, 'properties']);
    ...
    Route::middleware('role:admin,staff')->group(function (): void {
        ...
        Route::get('costs/months', [CostController::class, 'months']);
        Route::get('costs/monthly', [CostController::class, 'monthly']);
        Route::apiResource('costs', CostController::class);
        Route::get('costs/{cost}/receipt', [CostController::class, 'downloadReceipt']);
        Route::apiResource('recurring-costs', RecurringCostController::class)->only(['index', 'store', 'update', 'destroy']);
    ...
    Route::middleware('role:admin')->group(function (): void {
        ...
        Route::match(['put', 'patch'], 'hosting-servers/{hostingServer}', [HostingServerController::class, 'update'])->middleware('permission:hosting_credentials');
        Route::delete('hosting-servers/{hostingServer}', [HostingServerController::class, 'destroy'])->middleware('permission:hosting_credentials');
