...
<html lang="en" data-theme="light">
    ...
    <body data-auth="guest">
            ...
            <main class="main">
                ...
                <section class="view staff-view" data-view="websites">
                    <section class="content-grid websites-workspace">
                        <div class="card wide websites-directory-card">
                            <div class="card-header"><div><div class="card-title">Your websites</div><div class="card-subtitle" id="websites-list-subtitle">Hosting, WordPress and monitoring shown as one clear website record.</div></div><div class="card-header-actions"><button class="btn btn-primary admin-only" id="manual-website-toggle" type="button">Create new website</button><button class="btn btn-outline admin-only" id="krystal-import-open" type="button">Connect existing Krystal site</button><button class="btn btn-outline" id="websites-unlinked-toggle" type="button">Needs attention</button><button class="btn btn-outline" id="websites-refresh" type="button">Refresh</button></div></div>
                        ...
                        <div class="card wide admin-only krystal-import-card" id="krystal-import-panel" hidden>
                            ...
                            <details class="integration-settings">
                                ...
                                <div class="integration-settings-body">
                                    ...
                                    <form id="hosting-server-form" class="form-grid"><input name="id" type="hidden"><label class="field"><span>Connection name</span><input name="name" value="Krystal Trinity" required></label><label class="field"><span>WHM hostname</span><input name="hostname" placeholder="server.example.com" required></label><label class="field"><span>WHM reseller username</span><input name="username" autocomplete="off" required></label><label class="field"><span>WHM API token</span><input name="token" type="password" autocomplete="new-password" placeholder="Leave blank to keep saved token"></label><label class="field"><span>Development base domain</span><input name="development_base_domain" autocomplete="off" spellcheck="false" value="dev.web-stamp.co.uk" placeholder="dev.web-stamp.co.uk"><small>New development websites receive a unique subdomain here.</small></label><label class="field form-grid-wide"><span>SSH host fingerprint</span><input name="ssh_host_fingerprint" autocomplete="off" spellcheck="false" placeholder="SHA256:…"><small>Paste the verified SHA256 fingerprint for this Krystal server. This protects provisioning from connecting to an impersonated SSH server.</small></label><div class="form-hint form-grid-wide" id="hosting-server-status">Checking Krystal settings…</div><div class="form-grid-wide"><button class="btn btn-primary" type="submit">Save connection</button></div></form>
                                </div>
                            </details>
                        </div>
                ...
                <section class="view staff-view" data-view="website-detail">
                    <section class="content-grid">
                        <div class="card wide">
                            ...
                            <div class="health-band" id="website-detail-status-band"></div>
                        ...
                        <div class="card wide" data-website-tab-panel="analytics" hidden><div class="card-header"><div><div class="card-title">Traffic</div><div class="card-subtitle">Google Analytics 4 data, refreshed nightly.</div></div><div class="card-header-actions"><div class="analytics-range" id="website-analytics-range"><button class="btn btn-primary btn-small" type="button" data-analytics-range="28d">28 days</button><button class="btn btn-outline btn-small" type="button" data-analytics-range="90d">90 days</button><button class="btn btn-outline btn-small" type="button" data-analytics-range="month">This month</button><button class="btn btn-outline btn-small" type="button" data-analytics-range="last_month">Last month</button></div><button class="btn btn-outline btn-small" id="website-analytics-sync" type="button">Sync now</button><button class="btn btn-outline btn-small" id="website-analytics-backfill" type="button">Rebuild history</button></div></div><div id="website-analytics-panel-status" class="form-hint"></div><div class="analytics-tiles" id="website-analytics-tiles"></div><div class="analytics-chart" id="website-analytics-chart"></div><div class="analytics-breakdowns" id="website-analytics-breakdowns"></div></div>
                ...
                <section class="view portal-view" data-view="portal-website-detail">
                    <section class="content-grid portal-website-layout">
                        ...
                        <div class="card wide" id="portal-website-extras-card" hidden><div class="card-header"><div><div class="card-title">Good to know</div><div class="card-subtitle">Extra details about your website and hosting.</div></div></div><div class="detail-grid" id="portal-website-detail-care"></div></div>
                    </section>
                </section>
        ...
        <div class="crm-modal-backdrop" id="customer-website-modal" hidden>
            <section class="crm-modal customer-form-modal customer-website-modal" role="dialog" aria-modal="true" aria-labelledby="customer-website-title">
                ...
                <form id="customer-website-krystal-form" class="form-stack" hidden>
                    ...
                    <div class="website-setup-steps" id="customer-website-provisioning-steps" aria-label="Website creation steps"><div class="active"><span>1</span><strong>Details</strong></div><div><span>2</span><strong>Hosting</strong></div><div><span>3</span><strong>WordPress</strong></div><div><span>4</span><strong>Create</strong></div><div><span>5</span><strong>DNS &amp; SSL</strong></div></div>
                    <section data-provision-stage="1"><label class="field"><span>Website name</span><input name="name" required placeholder="Customer website"></label><div class="website-add-choices compact"><label class="website-add-choice"><input type="radio" name="environment" value="development" checked><strong>Development website</strong><span>Create on a private, search-blocked development subdomain and launch later.</span></label><label class="website-add-choice"><input type="radio" name="environment" value="production"><strong>Live website</strong><span>Create directly on its public domain.</span></label></div><label class="field" data-live-domain hidden><span>Live domain</span><input name="domain" placeholder="example.co.uk" inputmode="url" autocapitalize="none" spellcheck="false"></label><div class="guided-customer-label" data-development-domain><span>Development address</span><strong id="customer-website-development-domain">Enter a website name to generate an address</strong><button class="btn btn-outline btn-small" id="customer-website-regenerate-domain" type="button">Regenerate</button><small>The CRM checks both its own records and live Krystal accounts before using this address.</small></div><div class="form-actions"><button type="button" class="btn btn-outline" data-customer-website-back>Back</button><button type="button" class="btn btn-primary" data-provision-next>Continue</button></div></section>
                    <section data-provision-stage="2" hidden><label class="field"><span>Krystal hosting package</span><select name="hosting_package_id" id="customer-website-krystal-package" required><option value="">Select package</option></select></label><div class="guided-customer-label">The selected package must have Shell Access enabled. The CRM will create a separate cPanel account for this website.</div><div class="form-actions"><button type="button" class="btn btn-outline" data-provision-back>Back</button><button type="button" class="btn btn-primary" data-provision-next>Continue</button></div></section>
                    <section data-provision-stage="3" hidden><label class="field"><span>Website type</span><select name="website_type"><option value="wordpress">WordPress</option><option value="blank">Blank hosting</option></select></label><label class="field"><span>Setup profile</span><select name="wordpress_profile_id" id="customer-website-krystal-profile"><option value="">Standard defaults</option></select></label><label class="field"><span>Site title</span><input name="site_title" placeholder="Uses website name if blank"></label><label class="field"><span>WordPress admin username</span><input name="admin_username" value="webstamp_admin" autocomplete="off"></label><label class="field"><span>WordPress admin email</span><input name="admin_email" type="email" autocomplete="off"></label><label class="check-row"><input name="discourage_search_engines" type="checkbox"><span>Discourage search engines until launch</span></label><label class="check-row"><input name="install_agent" type="checkbox" checked><span>Set up WebStamp monitoring</span></label><div class="form-actions"><button type="button" class="btn btn-outline" data-provision-back>Back</button><button type="button" class="btn btn-primary" data-provision-next>Review setup</button></div></section>
                    <section data-provision-stage="4" hidden><div class="guided-customer-label"><strong>Ready to create</strong><br>The CRM will create the cPanel account, install and configure WordPress, then check DNS and SSL. No existing files will be overwritten.</div><div class="form-actions"><button type="button" class="btn btn-outline" data-provision-back>Back</button><button type="submit" class="btn btn-primary">Create and connect website</button></div></section>
                    <section data-provision-stage="5" hidden><div class="guided-customer-label" id="customer-website-provisioning-result">Starting setup…</div><div id="customer-website-provisioning-checklist" class="stack"></div><div class="form-actions"><button type="button" class="btn btn-outline" data-provision-check hidden>Check again</button><button type="button" class="btn btn-primary" data-provision-finish>Done</button></div></section>
        ...
        <div class="crm-modal-backdrop" id="website-go-live-modal" hidden>
            <section class="crm-modal customer-form-modal customer-website-modal" role="dialog" aria-modal="true" aria-labelledby="website-go-live-title">
                <div class="crm-modal-header"><div><div class="card-title" id="website-go-live-title">Go Live</div><div class="card-subtitle">Move this development website to its permanent domain safely.</div></div><button class="crm-modal-close" id="website-go-live-close" type="button" aria-label="Close">×</button></div>
                <form id="website-go-live-form" class="form-stack">
                    <div class="website-setup-steps" id="website-go-live-steps"><div class="active"><span>1</span><strong>Domain</strong></div><div><span>2</span><strong>Preflight</strong></div><div><span>3</span><strong>DNS</strong></div><div><span>4</span><strong>Launch</strong></div><div><span>5</span><strong>Verify</strong></div></div>
                    <section data-launch-stage="1"><div class="guided-customer-label">Development website: <strong id="website-go-live-development-domain">—</strong></div><label class="field"><span>Live domain</span><input name="production_domain" required placeholder="example.co.uk" inputmode="url" autocapitalize="none" spellcheck="false"></label><label class="check-row"><input name="enable_indexing" type="checkbox"><span>Allow search engines after launch</span></label><div class="form-actions"><button class="btn btn-primary" type="button" data-launch-preflight>Check readiness</button></div></section>
                    <section data-launch-stage="2" hidden><div class="guided-customer-label" id="website-go-live-preflight">Checking the development site and Krystal account…</div><div class="form-actions"><button class="btn btn-outline" type="button" data-launch-back>Back</button><button class="btn btn-primary" type="submit">Start launch</button></div></section>
                    <section data-launch-stage="3" hidden><div class="guided-customer-label" id="website-go-live-result">Preparing launch…</div><div class="stack" id="website-go-live-checklist"></div><div class="form-actions"><button class="btn btn-outline" type="button" data-launch-check hidden>Check again</button><button class="btn btn-primary" type="button" data-launch-finish>Done</button></div></section>
                    <div class="form-hint" id="website-go-live-status"></div>
                </form>
            </section>
        </div>
