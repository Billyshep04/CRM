            ...
            <main class="main">
                ...
                <section class="view staff-view" data-view="website-detail">
                    <section class="content-grid">
                        ...
                        <div class="card wide"><div class="card-header"><div><div class="card-title">Provisioning</div><div class="card-subtitle">Hosting and WordPress setup progress.</div></div></div><div class="stack" id="website-detail-provisioning"></div></div>
                    </section>
                </section>
